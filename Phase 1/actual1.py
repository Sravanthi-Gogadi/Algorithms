...
availability_list = [
    [{"type": 1, "zipcode": node1, "availability": 0}, {"type": 2, "zipcode": node1, "availability": 0},
    ...
    [{"type": 1, "zipcode": node5, "availability": 1}, {"type": 2, "zipcode": node5, "availability": 2},
...
f = open('out.html','a')
f.write("<p>The available node is at a distance of {} miles from {}".format(dis[0][0], dis[0][1].name+"</p>"))
req = dis[0][1]
##print(req)
al.getPath(req)
